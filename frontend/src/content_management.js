...
export function initializeContentManagementPage() {
    ...
    document.getElementById('export-world-btn')?.addEventListener('click', (e) => triggerWorldExport(e.currentTarget, serverName));
    document.getElementById('reset-world-btn')?.addEventListener('click', (e) => triggerWorldReset(e.currentTarget, serverName));
