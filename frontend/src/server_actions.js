...
function getSelectedServer() {
    ...
    if (!selectedServer || selectedServer === "") { // Check for empty string value explicitly
...
export function promptCommand(buttonElement) {
    ...
    if (command === null) { // User pressed Cancel on the prompt
    ...
    console.log(`${functionName}: Attempting to send command '${trimmedCommand}' to server '${serverName}' via API call to ${actionPath}...`);
