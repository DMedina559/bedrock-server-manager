...
export function initializeBackupRestorePage() {
    ...
    document.getElementById('backup-world-btn')?.addEventListener('click', (e) => triggerBackup(e.currentTarget, serverName, 'world'));
    document.getElementById('backup-all-btn')?.addEventListener('click', (e) => triggerBackup(e.currentTarget, serverName, 'all'));

    document.getElementById('select-world-backup-btn')?.addEventListener('click', (e) => handleSelectBackupType(e.currentTarget, serverName, 'world'));
    document.getElementById('select-properties-backup-btn')?.addEventListener('click', (e) => handleSelectBackupType(e.currentTarget, serverName, 'properties'));
    document.getElementById('select-allowlist-backup-btn')?.addEventListener('click', (e) => handleSelectBackupType(e.currentTarget, serverName, 'allowlist'));
    document.getElementById('select-permissions-backup-btn')?.addEventListener('click', (e) => handleSelectBackupType(e.currentTarget, serverName, 'permissions'));
    document.getElementById('restore-all-btn')?.addEventListener('click', (e) => triggerRestoreAll(e.currentTarget, serverName));

    document.getElementById('backup-allowlist-btn')?.addEventListener('click', (e) => triggerSpecificConfigBackup(e.currentTarget, serverName, 'allowlist.json'));
    document.getElementById('backup-permissions-btn')?.addEventListener('click', (e) => triggerSpecificConfigBackup(e.currentTarget, serverName, 'permissions.json'));
    document.getElementById('backup-properties-btn')?.addEventListener('click', (e) => triggerSpecificConfigBackup(e.currentTarget, serverName, 'server.properties'));
