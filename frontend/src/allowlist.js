...
export function initializeAllowlistPage() {
    ...
    async function addAllowlistPlayers(buttonElement) {
        ...
        const apiResponseData = await sendServerActionRequest(serverName, 'allowlist/add', 'POST', requestBody, buttonElement);
    ...
    async function removeAllowlistPlayer(buttonElement, playerName) {
        ...
        const apiResponseData = await sendServerActionRequest(serverName, 'allowlist/remove', 'DELETE', requestBody, buttonElement);
